  ...
  <head>
	...
	*/
	function search(){
	    ...
	    var url = "<common:WebRoot/>/v/present/pig/list?";
...
<div class="admin">
      <div class="tab-body">
        ...
        <div class="tab-panel active" id="tab-set">
        	...
        	<form action="<common:WebRoot/>/v/present/pig/list" method="post" id="allProjectForm" name="allProjectForm">
        		<!-- 隐藏域 用于编辑和删除使用 与搜索的ID区分开 -->
        		<input type="hidden" id="presentId" name="presentId" value=""/>
        		<input type="hidden" id="type" name="type" value="${type}"/>
			    <div class="panel admin-panel">
			    	<div class="panel-head"><strong>猪仔赠送记录</strong></div>
