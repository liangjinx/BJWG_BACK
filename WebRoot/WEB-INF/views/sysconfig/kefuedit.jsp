...
<html>
  <head>
	...
	function saveThisConfig(){	
		...
		$("#allProjectForm").attr("action","<common:WebRoot/>/v/kefu/config/edit").submit();
...
<div class="admin">
 <div class="tab">
  <div class="tab-head">
        <strong>在线客服设置设置</strong>
        <ul class="tab-nav">
          <li class="active"><a href="#tab-set">在线客服设置设置</a></li>
        </ul>
      </div>
      <div class="tab-body">
        <br />
        <div class="tab-panel active" id="tab-set">
        	...
        	<form id="allProjectForm" name="allProjectForm" method="post" class="form-x" action="<common:WebRoot/>/v/kefu/config/edit">
        		<%-- 隐藏域 --%>
