$(function(){
	...
	$pintuercheck=function(element,type,value){
		...
		switch(type){
			...
			case "phonenumber":return /^[\d-]{7,15}$/.test($pintu.replace(/[ ]/g,""));break;
			case "phonenumber2":return /^[\d]{3,15}$/.test($pintu.replace(/[ ]/g,""));break;
			...
			case "mobile":return  /^0?1[3|4|5|8][0-9]\d{8}$/.test($pintu);break;
			case "phone":return /^((\(\d{2,3}\))|(\d{3}\-))?(\(0\d{2,3}\)|0\d{2,3}-)?[1-9]\d{6,7}(\-\d{1,4})?$/.test($pintu)|| /^[48]00\d{7}$/.test($pintu);break;
			case "tel":return  /^0?1[3|4|5|8][0-9]\d{8}$/.test($pintu) || /^[48]00\d{7}$/.test($pintu) || /^((\(\d{2,3}\))|(\d{3}\-))?(\(0\d{2,3}\)|0\d{2,3}-)?[1-9]\d{6,7}(\-\d{1,4})?$/.test($pintu);break;
