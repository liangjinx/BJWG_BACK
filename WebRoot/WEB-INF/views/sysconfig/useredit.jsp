...
<html>
  <head>
	...
	function saveThisConfig(){	
		...
		$("#allProjectForm").attr("action","<common:WebRoot/>/v/user/config/edit").submit();
  ...
  <div class="tab-head">
      ...
      <div class="tab-body">
        ...
        <div class="tab-panel active" id="tab-set">
        	...
        	<form id="allProjectForm" name="allProjectForm" method="post" class="form-x" action="<common:WebRoot/>/v/user/config/edit">
        		<%-- 隐藏域 --%>
