  ...
  <head>
	...
	<script type="text/javascript">
		...
		function search(){
			...
			var url = "<common:WebRoot/>/v/bulletin/list?";
 ...
 * 资源编辑
 */
function bulletinEidt(type,id){
	var action = "";
	switch (type) {
	case 1://新增
		action = basePath + "/v/bulletin/editInit";
		break;
	case 2://修改
		action = basePath + "/v/bulletin/editInit";
		$("#id").val(id);
		break;
	case 3://单个删除
		action = basePath + "/v/bulletin/delete";
		if(confirm("是否确定删除记录？")){
			$("#id").val(id);
		}else{
			return ;
...
<div class="admin">
      <div class="tab-body">
        ...
        <div class="tab-panel active" id="tab-set">
        	...
        	<form action="<common:WebRoot/>/v/bulletin/list" method="post" id="allProjectForm" name="allProjectForm">
			    ...
			    <div class="panel admin-panel">
			        ...
			        <div class="padding border-bottom">
			            ...
			            <strong style="padding-left: 100px;">
				            ...
				            <man:hasPermission name="bulletin_delete">
				            	<input type="button" class="button button-small border-yellow" value="批量删除" onclick="bulletinEidt(4)"/>
				            </man:hasPermission>
			            </strong>
			        ...
			        <table class="table table-hover">
			        	...
			        	<c:forEach items="${requestScope.list }" var="l">
				            <tr>
				            	<td><input type="checkbox" name="idList" id="idList" value="${l.bulletinId}" /></td>
				            	<td>
				            		${l.title}
				            	</td>
				            	...
				            	<td>
				            		<man:hasPermission name="bulletin_edit_init">
				            			<a class="button border-blue button-little" href="javascript:bulletinEidt(2,${l.bulletinId});">编辑</a>
				            		</man:hasPermission>
				            		<man:hasPermission name="bulletin_delete">
				            			<a class="button border-yellow button-little" href="javascript:bulletinEidt(3,${l.bulletinId});">删除</a>
				            		</man:hasPermission>
				            	</td>
				            </tr>
			        	</c:forEach>
